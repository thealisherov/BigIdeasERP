...
export const paymentsApi = {
  ...
  getByCategory: (category, params = {}) => {
    const branchId = getUserBranchId();
    return api.get('/payments/by-category', { params: { branchId, category, ...params } });
  },
  getByCategoryAndMonth: (category, year, month, params = {}) => {
    const branchId = getUserBranchId();
    return api.get('/payments/by-category-and-month', { params: { branchId, category, year, month, ...params } });
  },
};
